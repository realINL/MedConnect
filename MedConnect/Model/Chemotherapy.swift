...
extension Chemotherapy {
    static let MOCK_Chemotherapy: [Chemotherapy] = [Chemotherapy(id: "0", patientId: "0", 
                                                                 staus: 
            .completed(scheme: .FLOT, endDate: Date.fromString("11.12.2021")!),
//        .none,
                                                                 numberOfCourses: 3, startDate: Date.fromString("11.11.2021")!, endDate: Date.fromString("11.12.2021")!)]
}
